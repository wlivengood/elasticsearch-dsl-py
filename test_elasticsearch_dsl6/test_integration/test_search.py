...
from elasticsearch_dsl6 import Search, DocType, Date, Text, Keyword, MultiSearch, \
    Index, Q
from elasticsearch_dsl6.response import aggs
...
def test_filters_aggregation_buckets_are_accessible(data_client):
    has_tests_query = Q('term', files='test_elasticsearch_dsl6')
    s = Commit.search()[0:0]
    s.aggs\
