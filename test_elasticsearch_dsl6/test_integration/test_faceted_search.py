...
from elasticsearch_dsl6 import DocType, Boolean, Date
from elasticsearch_dsl6.faceted_search import FacetedSearch, TermsFacet, \
...
def test_empty_search_finds_everything(data_client):
    ...
    assert [
        ('elasticsearch_dsl6', 40, False),
        ('test_elasticsearch_dsl6', 35, False),
        ('elasticsearch_dsl6/query.py', 19, False),
        ('test_elasticsearch_dsl6/test_search.py', 15, False),
        ('elasticsearch_dsl6/utils.py', 14, False),
        ('test_elasticsearch_dsl6/test_query.py', 13, False),
        ('elasticsearch_dsl6/search.py', 12, False),
        ('elasticsearch_dsl6/aggs.py', 11, False),
        ('test_elasticsearch_dsl6/test_result.py', 5, False),
        ('elasticsearch_dsl6/result.py', 3, False)
    ] == r.facets.files
...
def test_term_filters_are_shown_as_selected_and_data_is_filtered(data_client):
    cs = CommitSearch(filters={'files': 'test_elasticsearch_dsl6'})
    ...
    assert [
        ('elasticsearch_dsl6', 40, False),
        ('test_elasticsearch_dsl6', 35, True), # selected
        ('elasticsearch_dsl6/query.py', 19, False),
        ('test_elasticsearch_dsl6/test_search.py', 15, False),
        ('elasticsearch_dsl6/utils.py', 14, False),
        ('test_elasticsearch_dsl6/test_query.py', 13, False),
