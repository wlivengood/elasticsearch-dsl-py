...
class IndexBody(object):
    ...
    def mapping(self, mapping):
        ...
        :class:`~elasticsearch_dsl6.Mapping`) with this index.
    ...
    def doc_type(self, doc_type):
        """
        Associate a :class:`~elasticsearch_dsl6.DocType` subclass with an index.
        This means that, when this index is created, it will contain the
...
class IndexTemplate(IndexBody):
    ...
    def search(self):
        """
        Return a :class:`~elasticsearch_dsl6.Search` object searching over all
...
class Index(IndexBody):
    def search(self):
        """
        Return a :class:`~elasticsearch_dsl6.Search` object searching over this
