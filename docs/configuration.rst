...
When using ``elasticsearch_dsl6`` it is highly recommended to use the attached
serializer (``elasticsearch_dsl6.serializer.serializer``) that will make sure
...
.. code:: python
    ...
    from elasticsearch_dsl6 import connections
